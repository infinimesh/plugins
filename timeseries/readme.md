...
The plugin works with [Redis Enterprise Cloud](https://redislabs.com/redis-enterprise-cloud/overview/), just edit the connection string in [provisioning/datasources/redists.yaml](provisioning/datasources/redists.yaml) like:  
```
